...
# setup networking
playback-nic --purge --public --user ubuntu --host 10.32.150.19 --nic eth1 --address 10.32.151.19 --netmask 255.255.255.0 --gateway 10.32.151.1 --dns-nameservers "10.32.11.11 10.32.11.12"
playback-nic --user ubuntu --host 10.32.150.19 --private --nic eth2 --address 192.168.1.12 --netmask 255.255.255.0
playback-nic --user ubuntu --host 10.32.150.19 --restart
playback-nic --purge --public --user ubuntu --host 10.32.150.17 --nic eth1 --address 10.32.151.17 --netmask 255.255.255.0 --gateway 10.32.151.1 --dns-nameservers "10.32.11.11 10.32.11.12"
playback-nic --user ubuntu --host 10.32.150.17 --private --nic eth2 --address 192.168.1.13 --netmask 255.255.255.0
playback-nic --user ubuntu --host 10.32.150.17 --restart
playback-nic --purge --public --user ubuntu --host 10.32.150.16 --nic eth1 --address 10.32.151.16 --netmask 255.255.255.0 --gateway 10.32.151.1 --dns-nameservers "10.32.11.11 10.32.11.12"
playback-nic --user ubuntu --host 10.32.150.16 --private --nic eth2 --address 192.168.1.14 --netmask 255.255.255.0
playback-nic --user ubuntu --host 10.32.150.16 --restart
playback-nic --purge --public --user ubuntu --host 10.32.150.22 --nic eth1 --address 10.32.151.22 --netmask 255.255.255.0 --gateway 10.32.151.1 --dns-nameservers "10.32.11.11 10.32.11.12"
playback-nic --user ubuntu --host 10.32.150.22 --private --nic eth2 --address 192.168.1.20 --netmask 255.255.255.0
playback-nic --user ubuntu --host 10.32.150.22 --restart
playback-nic --purge --public --user ubuntu --host 10.32.150.18 --nic eth1 --address 10.32.151.18 --netmask 255.255.255.0 --gateway 10.32.151.1 --dns-nameservers "10.32.11.11 10.32.11.12"
playback-nic --user ubuntu --host 10.32.150.18 --private --nic eth2 --address 192.168.1.18 --netmask 255.255.255.0
playback-nic --user ubuntu --host 10.32.150.18 --restart
playback-nic --purge --public --user ubuntu --host 10.32.150.25 --nic eth1 --address 10.32.151.25 --netmask 255.255.255.0 --gateway 10.32.151.1 --dns-nameservers "10.32.11.11 10.32.11.12"
playback-nic --user ubuntu --host 10.32.150.25 --private --nic eth2 --address 192.168.1.17 --netmask 255.255.255.0
playback-nic --user ubuntu --host 10.32.150.25 --restart
playback-nic --purge --public --user ubuntu --host 10.32.150.12 --nic eth1 --address 10.32.151.12 --netmask 255.255.255.0 --gateway 10.32.151.1 --dns-nameservers "10.32.11.11 10.32.11.12"
playback-nic --user ubuntu --host 10.32.150.12 --private --nic eth2 --address 192.168.1.16 --netmask 255.255.255.0
playback-nic --user ubuntu --host 10.32.150.12 --restart
playback-nic --purge --public --user ubuntu --host 10.32.150.14 --nic eth1 --address 10.32.151.14 --netmask 255.255.255.0 --gateway 10.32.151.1 --dns-nameservers "10.32.11.11 10.32.11.12"
playback-nic --user ubuntu --host 10.32.150.14 --private --nic eth2 --address 192.168.1.15 --netmask 255.255.255.0
playback-nic --user ubuntu --host 10.32.150.14 --restart
...
# install rabbit
ssh ubuntu@10.32.151.19 'echo "10.32.151.17 controller02" | sudo tee -a /etc/hosts'
ssh ubuntu@10.32.151.17 'echo "10.32.151.19 controller01" | sudo tee -a /etc/hosts'
...
scp ubuntu@10.32.151.19:/etc/swift/*.gz patch/
scp patch/*.gz ubuntu@10.32.151.17:~
scp patch/*.gz ubuntu@10.32.151.12:~
scp patch/*.gz ubuntu@10.32.151.14:~

ssh ubuntu@10.32.151.17 sudo cp *.gz /etc/swift
ssh ubuntu@10.32.151.12 sudo cp *.gz /etc/swift
ssh ubuntu@10.32.151.14 sudo cp *.gz /etc/swift
...
# install ceph admin
ssh ubuntu@10.32.151.19 ssh-keygen
scp ubuntu@10.32.151.19:~/.ssh/id_rsa.pub patch/
scp ubuntu@10.32.151.19:~/.ssh/id_rsa patch/
ssh-copy-id -i patch/id_rsa.pub ubuntu@10.32.151.19
ssh-copy-id -i patch/id_rsa.pub ubuntu@10.32.151.17
ssh-copy-id -i patch/id_rsa.pub ubuntu@10.32.151.16
ssh-copy-id -i patch/id_rsa.pub ubuntu@10.32.151.22
ssh-copy-id -i patch/id_rsa.pub ubuntu@10.32.151.18
ssh-copy-id -i patch/id_rsa.pub ubuntu@10.32.151.25
ssh-copy-id -i patch/id_rsa.pub ubuntu@10.32.151.12
ssh-copy-id -i patch/id_rsa.pub ubuntu@10.32.151.14
playback --ansible 'openstack_ceph_admin.yml -vvvv'

# init ceph monitor
ssh ubuntu@10.32.151.19 'echo "10.32.151.19 controller01" | sudo tee -a /etc/hosts'
ssh ubuntu@10.32.151.19 'echo "10.32.151.16 compute01" | sudo tee -a /etc/hosts'
ssh ubuntu@10.32.151.19 'echo "10.32.151.22 compute02" | sudo tee -a /etc/hosts'
ssh ubuntu@10.32.151.19 'echo "10.32.151.18 compute03" | sudo tee -a /etc/hosts'
ssh ubuntu@10.32.151.19 'echo "10.32.151.25 compute04" | sudo tee -a /etc/hosts'
ssh ubuntu@10.32.151.19 'echo "10.32.151.12 compute05" | sudo tee -a /etc/hosts'
ssh ubuntu@10.32.151.19 'echo "10.32.151.14 compute06" | sudo tee -a /etc/hosts'
playback --ansible 'openstack_ceph_initial_mon.yml -vvvv'


# deploy ceph clients
ssh ubuntu@10.32.151.19 'ssh -o "StrictHostKeyChecking no" ubuntu@controller01 true'
ssh ubuntu@10.32.151.19 'ssh -o "StrictHostKeyChecking no" ubuntu@controller02 true'
ssh ubuntu@10.32.151.19 'ssh -o "StrictHostKeyChecking no" ubuntu@compute01 true'
ssh ubuntu@10.32.151.19 'ssh -o "StrictHostKeyChecking no" ubuntu@compute02 true'
ssh ubuntu@10.32.151.19 'ssh -o "StrictHostKeyChecking no" ubuntu@compute03 true'
ssh ubuntu@10.32.151.19 'ssh -o "StrictHostKeyChecking no" ubuntu@compute04 true'
ssh ubuntu@10.32.151.19 'ssh -o "StrictHostKeyChecking no" ubuntu@compute05 true'
ssh ubuntu@10.32.151.19 'ssh -o "StrictHostKeyChecking no" ubuntu@compute06 true'
...
ssh ubuntu@10.32.151.19 'ceph auth get-or-create client.cinder | ssh ubuntu@controller01 sudo tee /etc/ceph/ceph.client.cinder.keyring'
ssh ubuntu@10.32.151.19 'ceph auth get-or-create client.cinder | ssh ubuntu@controller02 sudo tee /etc/ceph/ceph.client.cinder.keyring'
ssh ubuntu@10.32.151.19 'ceph auth get-or-create client.cinder | ssh ubuntu@compute01 sudo tee /etc/ceph/ceph.client.cinder.keyring'
ssh ubuntu@10.32.151.19 'ceph auth get-or-create client.cinder | ssh ubuntu@compute02 sudo tee /etc/ceph/ceph.client.cinder.keyring'
ssh ubuntu@10.32.151.19 'ceph auth get-or-create client.cinder | ssh ubuntu@compute03 sudo tee /etc/ceph/ceph.client.cinder.keyring'
ssh ubuntu@10.32.151.19 'ceph auth get-or-create client.cinder | ssh ubuntu@compute04 sudo tee /etc/ceph/ceph.client.cinder.keyring'
ssh ubuntu@10.32.151.19 'ceph auth get-or-create client.cinder | ssh ubuntu@compute05 sudo tee /etc/ceph/ceph.client.cinder.keyring'
ssh ubuntu@10.32.151.19 'ceph auth get-or-create client.cinder | ssh ubuntu@compute06 sudo tee /etc/ceph/ceph.client.cinder.keyring'


# restart volume service dependency to take effect for ceph backend
echo '10.32.151.19 controller01' | sudo tee -a /etc/hosts
echo '10.32.151.17 controller02' | sudo tee -a /etc/hosts
...
ssh ubuntu@10.32.151.19 'sudo cp /root/admin-openrc.sh /home/ubuntu'
ssh ubuntu@10.32.151.19 'source ~/admin-openrc.sh && nova network-create ext-net --bridge br100 --multi-host T --fixed-range-v4 172.16.0.0/16'
ssh ubuntu@10.32.151.19 'source ~/admin-openrc.sh && nova floating-ip-bulk-create --pool ext-net 10.32.151.65/26'
ssh ubuntu@10.32.151.19 'source ~/admin-openrc.sh && nova floating-ip-bulk-list'

# extend the ext-net pool
ssh ubuntu@10.32.151.19 'source ~/admin-openrc.sh && nova floating-ip-bulk-create --pool ext-net 10.32.151.128/26'
ssh ubuntu@10.32.151.19 'source ~/admin-openrc.sh && nova floating-ip-bulk-create --pool ext-net 10.32.151.192/26'
ssh ubuntu@10.32.151.19 'source ~/admin-openrc.sh && nova floating-ip-bulk-list'
