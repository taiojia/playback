...
func (s *StorageClientSuite) TestGetBaseURL_Basic_Https(c *chk.C) {
	...
	c.Assert(err, chk.IsNil)
	c.Assert(cli.getBaseURL("table"), chk.Equals, "https://foo.table.core.chinacloudapi.cn")
}
...
func (s *StorageClientSuite) TestGetEndpoint_None(c *chk.C) {
	...
	c.Assert(output, chk.Equals, "https://foo.blob.core.chinacloudapi.cn/")
}
...
func (s *StorageClientSuite) TestGetEndpoint_PathOnly(c *chk.C) {
	...
	c.Assert(output, chk.Equals, "https://foo.blob.core.chinacloudapi.cn/path")
}
...
func (s *StorageClientSuite) TestGetEndpoint_ParamsOnly(c *chk.C) {
	...
	c.Assert(output, chk.Equals, "https://foo.blob.core.chinacloudapi.cn/?a=b&c=d")
}
...
func (s *StorageClientSuite) TestGetEndpoint_Mixed(c *chk.C) {
	...
	c.Assert(output, chk.Equals, "https://foo.blob.core.chinacloudapi.cn/path?a=b&c=d")
}
...
func (s *StorageClientSuite) Test_buildCanonicalizedResource(c *chk.C) {
	...
	tests := []test{
		{"https://foo.blob.core.chinacloudapi.cn/path?a=b&c=d", "/foo/path\na:b\nc:d"},
		{"https://foo.blob.core.chinacloudapi.cn/?comp=list", "/foo/\ncomp:list"},
		{"https://foo.blob.core.chinacloudapi.cn/cnt/blob", "/foo/cnt/blob"},
	}
